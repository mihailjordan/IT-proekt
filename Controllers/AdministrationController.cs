        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role can not be deleted as there is users in this role." +
                        $"If you want to delete this role, please remove users from the role and try again to delete";
